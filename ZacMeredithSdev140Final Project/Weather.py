# This file uses the weather api to get access to the
# current weather of the location you are looking up
import requests

API_KEY = '776921dd00a24a27a0822046230305'


# this class defines the current data of the weather
class Weather:
